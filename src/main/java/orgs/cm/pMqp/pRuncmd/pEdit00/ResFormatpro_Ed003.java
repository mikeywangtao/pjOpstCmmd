 ...
 * */
public class ResFormatpro_Ed003 {
	
	private final String strCname = ResFormatpro_Ed003.class.getName();
							...
							if(booFlg && strInfo.indexOf("| ")>-1){
								...
								if(subInfo!=null && subInfo.length==4
										&& ("status".equals(subInfo[1].trim())
												|| "flavor".equals(subInfo[1].trim()))){
									strRe = strRe + ",,," + subInfo[2].trim()+"}}}"+subInfo[1].trim();
//									break;
								}
							}
						}
