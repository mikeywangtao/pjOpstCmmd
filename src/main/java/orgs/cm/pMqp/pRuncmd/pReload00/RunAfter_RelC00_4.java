...
public class RunAfter_RelC00_4 extends AbsRunAfter {


	private AbsDbpro objDbpro = null;
	private HashMap<String, Object> hmpAll;
	private final String strCname = RunAfter_RelC00_4.class.getName();
...
//				hmpAll.put(ProcessAttrs.strParmapKey_Aftlst, altRunc);
				...
				if(strAnsidf!=null && strAnsidf.trim().length()>0){
					ResFormatpro_RelC004 objResFormatpro = new ResFormatpro_RelC004(
							hmpAll, 
