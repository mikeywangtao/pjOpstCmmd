 ...
 * */
public class ResFormatpro_RelDe001 {
	
	private final String strCname = ResFormatpro_RelDe001.class.getName();
...
//	private ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();	
	...
	private ResFormatpro_RelDe001(){};
	
	private String strBaseFlg = null;
	private ArrayList<LinkedHashMap<String, String>> altRes;
	public ResFormatpro_RelDe001(HashMap<String, Object> hmpParp
