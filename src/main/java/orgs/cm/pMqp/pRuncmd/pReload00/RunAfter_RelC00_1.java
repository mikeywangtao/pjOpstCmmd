 ...
 * 创建vm命令1，命令运行后的处理
 * */
public class RunAfter_RelC00_1 extends AbsRunAfter {


	private AbsDbpro objDbpro = null;
	private HashMap<String, Object> hmpAll;
	private final String strCname = RunAfter_RelC00_1.class.getName();
...
//				hmpAll.put(ProcessAttrs.strParmapKey_Aftlst, altRunc);
				...
				if(hmpAll.containsKey(ProcessAttrs.strInfoFlgKey_Resstd)
					...
					ResFormatpro_RelC001 objResFormatpro_1 = new ResFormatpro_RelC001(hmpAll, (ArrayList<LinkedHashMap<String, String>>)hmpAll.get(ProcessAttrs.strInfoFlgKey_Resstd), objBa);
					objResFormatpro_1.disFormatpro();
					hmpAll.put(ProcessAttrs.strParmapKey_Ppa_NowRunflg, "4");
					strInfo = strCname + strFname + " VM创建 After01 ----strParmapKey_Ppa_NowRunflg OK 4" + DatePro.disGetStrdate4NowObjSdf001();
					objBa.altRunc = objBa.objSetInfoPro.disSetInfo_000(strInfo, objBa.lhpInfobase, objBa.altRunc, ProcessAttrs.strInfoFlg_Elx + " strParmapKey_Ppa_NowRunflg OK 4 " );
					hmpAll.put(ProcessAttrs.strParmapKey_Aftlst, objBa.altRunc);
				}
				if(hmpAll.containsKey(ProcessAttrs.strInfoFlgKey_Reserr)
						&& hmpAll.get(ProcessAttrs.strInfoFlgKey_Reserr)!=null){
					ResFormatpro_RelC001 objResFormatpro_1 = new ResFormatpro_RelC001(hmpAll, (ArrayList<LinkedHashMap<String, String>>)hmpAll.get(ProcessAttrs.strInfoFlgKey_Reserr), objBa);
					objResFormatpro_1.disFormatpro();
