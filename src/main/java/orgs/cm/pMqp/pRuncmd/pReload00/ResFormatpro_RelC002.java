 ...
 * */
public class ResFormatpro_RelC002 {
	
	private final String strCname = ResFormatpro_RelC002.class.getName();
...
//	private ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();	
	...
	private ResFormatpro_RelC002(){};
	
	private String strBaseFlg = null;
	private ArrayList<LinkedHashMap<String, String>> altRes;
	public ResFormatpro_RelC002(HashMap<String, Object> hmpParp
