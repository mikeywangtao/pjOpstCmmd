 ...
 * */
public class ResFormatpro_RelC003 {
	
	private final String strCname = ResFormatpro_RelC003.class.getName();
...
//	private ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();	
	...
	private ResFormatpro_RelC003(){};
	
	private String strAnsId = "0";
	private ArrayList<LinkedHashMap<String, String>> altRes;
	public ResFormatpro_RelC003(HashMap<String, Object> hmpParp
