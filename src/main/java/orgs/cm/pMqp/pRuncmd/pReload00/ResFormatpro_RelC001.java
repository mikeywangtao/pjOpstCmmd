 ...
 * */
public class ResFormatpro_RelC001 {
	
	private final String strCname = ResFormatpro_RelC001.class.getName();
...
//	private ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();	
	...
	private ResFormatpro_RelC001(){};
	
	private ArrayList<LinkedHashMap<String, String>> altRes;
	public ResFormatpro_RelC001(HashMap<String, Object> hmpParp
