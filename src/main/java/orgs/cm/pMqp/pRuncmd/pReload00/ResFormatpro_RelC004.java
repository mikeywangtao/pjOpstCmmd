 ...
 * */
public class ResFormatpro_RelC004 {
	
	private final String strCname = ResFormatpro_RelC004.class.getName();
...
//	private ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();	
	...
	public ResFormatpro_RelC004(HashMap<String, Object> hmpParp
