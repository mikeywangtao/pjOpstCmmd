...
public class RunAfter_RelC00_2 extends AbsRunAfter {


	private AbsDbpro objDbpro = null;
	private HashMap<String, Object> hmpAll;
	private final String strCname = RunAfter_RelC00_2.class.getName();
...
//				hmpAll.put(ProcessAttrs.strParmapKey_Aftlst, altRunc);
				...
				if(hmpAll.containsKey(ProcessAttrs.strInfoFlgKey_Resstd)
					...
					if(strDevname!=null && strDevname.trim().length()>0){
						...
						ResFormatpro_RelC002 objResFormatpro_2 = new ResFormatpro_RelC002(hmpAll, altStd, strDevname, objBa);
						...
						if(subFlg!=null && subFlg.length==2){
							if("available".equals(subFlg[0])){
								...
								hmpAll.put(ProcessAttrs.strParmapKey_Ppa_NowRunflg, "5");
