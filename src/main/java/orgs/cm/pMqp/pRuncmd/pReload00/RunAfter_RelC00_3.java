...
public class RunAfter_RelC00_3 extends AbsRunAfter {


	private AbsDbpro objDbpro = null;
	private HashMap<String, Object> hmpAll;
	private final String strCname = RunAfter_RelC00_3.class.getName();
...
//				hmpAll.put(ProcessAttrs.strParmapKey_Aftlst, altRunc);
				...
				if(strAnsidf!=null && strAnsidf.trim().length()>0){
					ResFormatpro_RelC003 objResFormatpro = new ResFormatpro_RelC003(
							hmpAll, 
					...
					if(strFlg!=null && strFlg.trim().length()>0){
						...
						if(subFlg!=null && subFlg.length==2){
							hmpAll.put(ProcessAttrs.strParmapKey_Ppa_NowRunflg, "6");
