 ...
 * 创建一个。
 * */
public class Runcmdpro_Reload00 extends AbsRuncmdPro implements Runnable {

	private final String strCname = Runcmdpro_Reload00.class.getName();
...
//				HashMap map = altDataAnsible.get(0);
				...
				objPrepare = new RunPrepare_Reload00();
				...
				if(hmpPar.containsKey(ProcessAttrs.strParmapKey_Ppa_NowRunflg) 
					...
					do {
						...
						objBefore = new RunBefore_RelDe00_2();
						objBefore.disSetHmpall(hmpPar);
						objBefore.disSetClsBaseAttrs(objBa);
						super.disRunBefre(objBefore);
						objBefore = null;
						
						objCmd = new RunCmd_RelDe00_2();
						objCmd.disSetHmpall(hmpPar);
						objCmd.disSetClsBaseAttrs(objBa);
						super.disRunCmd(objCmd);
						objCmd = null;
						
						objAfter = new RunAfter_RelDe00_2();
						objAfter.disSetHmpall(hmpPar);
						objAfter.disSetClsBaseAttrs(objBa);
						super.dusRunAfter(objAfter);
						objAfter = null;
				...
				if(hmpPar.containsKey(ProcessAttrs.strParmapKey_Ppa_NowRunflg) 
					...
					objBefore = new RunBefore_RelC00_1();
					objBefore.disSetHmpall(hmpPar);
					objBefore.disSetClsBaseAttrs(objBa);
					super.disRunBefre(objBefore);
					objBefore = null;
					
					objCmd = new RunCmd_RelC00_1();
					objCmd.disSetHmpall(hmpPar);
					objCmd.disSetClsBaseAttrs(objBa);
					super.disRunCmd(objCmd);
					objCmd = null;
					
					objAfter = new RunAfter_RelC00_1();
					objAfter.disSetHmpall(hmpPar);
					objAfter.disSetClsBaseAttrs(objBa);
					super.dusRunAfter(objAfter);
					objAfter = null;
				...
				if(hmpPar.containsKey(ProcessAttrs.strParmapKey_Ppa_NowRunflg) 
					...
					String strRunlopp = null;
					do {
						objBefore = new RunBefore_RelC00_2();
						objBefore.disSetHmpall(hmpPar);
						objBefore.disSetClsBaseAttrs(objBa);
						super.disRunBefre(objBefore);
						objBefore = null;
						
						objCmd = new RunCmd_RelC00_2();
						objCmd.disSetHmpall(hmpPar);
						objCmd.disSetClsBaseAttrs(objBa);
						super.disRunCmd(objCmd);
						objCmd = null;
						
						objAfter = new RunAfter_RelC00_2();
						objAfter.disSetHmpall(hmpPar);
						objAfter.disSetClsBaseAttrs(objBa);
						super.dusRunAfter(objAfter);
						objAfter = null;
				...
				if(hmpPar.containsKey(ProcessAttrs.strParmapKey_Ppa_NowRunflg) 
						&& hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg)!=null
						&& "5".equals(hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg).toString().trim())){
					strInfo = strCname + strFname + 
							ProcessAttrs.strParmapKey_Ppa_NowRunflg + ":" + hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg) +
							" run cmmd 5 " + hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg);
					...
					objBefore = new RunBefore_RelC00_3();
					objBefore.disSetHmpall(hmpPar);
					objBefore.disSetClsBaseAttrs(objBa);
					super.disRunBefre(objBefore);
					objBefore = null;
					
					objCmd = new RunCmd_RelC00_3();
					objCmd.disSetHmpall(hmpPar);
					objCmd.disSetClsBaseAttrs(objBa);
					super.disRunCmd(objCmd);
					objCmd = null;
					
					objAfter = new RunAfter_RelC00_3();
					objAfter.disSetHmpall(hmpPar);
					objAfter.disSetClsBaseAttrs(objBa);
					super.dusRunAfter(objAfter);
					objAfter = null;
				...
				if(hmpPar.containsKey(ProcessAttrs.strParmapKey_Ppa_NowRunflg) 
						&& hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg)!=null
						&& "6".equals(hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg).toString().trim())){
					strInfo = strCname + strFname + 
							ProcessAttrs.strParmapKey_Ppa_NowRunflg + ":" + hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg) +
							" run cmmd 6 " + hmpPar.get(ProcessAttrs.strParmapKey_Ppa_NowRunflg);
...
//					Thread.sleep(5000);
					objBefore = new RunBefore_RelC00_4();
					objBefore.disSetHmpall(hmpPar);
					objBefore.disSetClsBaseAttrs(objBa);
					super.disRunBefre(objBefore);
					objBefore = null;
					
					objCmd = new RunCmd_RelC00_4();
					objCmd.disSetHmpall(hmpPar);
					objCmd.disSetClsBaseAttrs(objBa);
					super.disRunCmd(objCmd);
					objCmd = null;
					
					objAfter = new RunAfter_RelC00_4();
					objAfter.disSetHmpall(hmpPar);
					objAfter.disSetClsBaseAttrs(objBa);
					super.dusRunAfter(objAfter);
					objAfter = null;
			...
			if(objBa!=null && objSaveInfoPro!=null){
				AbsRunFinally objRunFinally = new RunFinally_Reload00();
...
//				hmpAllInp.put("^vmids^", null);
				...
				hmpPar.put("^vmids^", hmpAllInp.get("^vmids^"));//vm id
				...
				hmpPar.put("^intId^", hmpAllInp.get("^intVmId^"));//auth vm id
