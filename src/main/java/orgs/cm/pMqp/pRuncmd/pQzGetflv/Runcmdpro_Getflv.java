...
public class Runcmdpro_Getflv extends AbsRuncmdPro implements Runnable {

	private final String strCname = Runcmdpro_Getflv.class.getName();
	private final Logger logger = LogManager.getLogger(strCname);
	
	private static final String strInfoflg = "flvJob";
...
//				hmpPar = new HashMap<>();
				...
				hmpPar.put(ProcessAttrs.strParmapKey_Ppa_ShFilename, 
						"/" 
						+ "Getflv_"+DatePro.disGetStrdate4NowObjSdf001() 
