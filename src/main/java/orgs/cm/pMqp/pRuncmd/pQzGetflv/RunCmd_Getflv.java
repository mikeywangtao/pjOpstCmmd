...
public class RunCmd_Getflv extends AbsRunCmd {
...
STD line: } */
			...
			errorGobbler = new CmdStreamGobbler(process.getErrorStream(), command, "查看模板 ERR", strstrCpuuid, this);
			outputGobbler = new CmdStreamGobbler(process.getInputStream(), command, "查看模板 STD", strstrCpuuid, this);
...
//			process = Runtime.getRuntime().exec(command);
//
//			errorGobbler = new CmdStreamGobbler(process.getErrorStream(), command, "查看模板 ERR", this);
//			outputGobbler = new CmdStreamGobbler(process.getInputStream(), command, "查看模板 STD", this);
//		
//			if(errorGobbler!=null && outputGobbler!=null){
//				errorGobbler.start();
