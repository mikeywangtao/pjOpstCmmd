...
STD line: } */
			...
			CmdStreamGobbler errorGobbler = new CmdStreamGobbler(process.getErrorStream(), command, "查看模板 ERR");
			CmdStreamGobbler outputGobbler = new CmdStreamGobbler(process.getInputStream(), command, "查看模板 STD");
			errorGobbler.start();
