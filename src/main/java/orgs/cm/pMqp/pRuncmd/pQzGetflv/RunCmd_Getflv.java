...
STD line: } */
			...
			CmdStreamGobbler errorGobbler = new CmdStreamGobbler(process.getErrorStream(), command, "查看模板 ERR", this);
			CmdStreamGobbler outputGobbler = new CmdStreamGobbler(process.getInputStream(), command, "查看模板 STD", this);
			errorGobbler.start();
