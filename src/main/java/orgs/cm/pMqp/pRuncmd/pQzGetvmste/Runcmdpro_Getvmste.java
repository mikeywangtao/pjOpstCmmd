...
public class Runcmdpro_Getvmste extends AbsRuncmdPro implements Runnable {

	private final String strCname = Runcmdpro_Getvmste.class.getName();
	private final Logger logger = LogManager.getLogger(strCname);
	
	private static final String strInfoflg = "vmsteJob";
...
//				hmpPar = new HashMap<>();
				...
				hmpPar.put(ProcessAttrs.strParmapKey_Ppa_ShFilename, 
						"/" 
						+ "Getvmste_"+DatePro.disGetStrdate4NowObjSdf001() 
