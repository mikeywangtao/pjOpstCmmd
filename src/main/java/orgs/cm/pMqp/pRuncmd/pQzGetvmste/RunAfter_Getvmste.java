...
public class RunAfter_Getvmste extends AbsRunAfter {

//	private AbsDbpro objDbpro = null;
	private HashMap<String, Object> hmpAll;
	private final String strCname = RunAfter_Getvmste.class.getName();
					...
					if(strAnsidf!=null && strAnsidf.trim().length()>0){
						...
						if(altResf!=null){
							...
							if(strReq!=null && strReq.trim().length()>0){
								...
								logger.info(strInfo);
								String strSetImgres = objHttpClientUtil.sendHttpPostJson("http://"+strRemoteSer+":"+strReSerpoint+"/pjOpStAuth/web/vm/updateVmStatus", strSetImg);
