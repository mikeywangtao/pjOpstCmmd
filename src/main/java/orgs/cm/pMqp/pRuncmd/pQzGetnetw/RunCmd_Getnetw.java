...
STD line: } */
			...
			CmdStreamGobbler errorGobbler = new CmdStreamGobbler(process.getErrorStream(), command, "查看网络 ERR", this);
			CmdStreamGobbler outputGobbler = new CmdStreamGobbler(process.getInputStream(), command, "查看网络 STD", this);
			errorGobbler.start();
