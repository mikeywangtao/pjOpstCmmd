...
//		ArrayList<LinkedHashMap<String, String>> altRunc = new ArrayList<LinkedHashMap<String, String>>();		
		try {
			...
			strInfo = strCname + strFname + " 查看网络 Runcmd01 Start----" + DatePro.disGetStrdate4NowObjSdf001();
...
//			StrCommand = StrCommand.replaceAll(",", "");
			...
			errorGobbler = new CmdStreamGobbler(process.getErrorStream(), StrCommand, "查看网络 ERR", strstrCpuuid, this);
			outputGobbler = new CmdStreamGobbler(process.getInputStream(), StrCommand, "查看网络 STD", strstrCpuuid, this);
...
//							errorGobbler.setStop();
				...
				super.strThrflg = null;
				strInfo = strCname + strFname + " 查看网络 Runcmd01 End----" + DatePro.disGetStrdate4NowObjSdf001();
